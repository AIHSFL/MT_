...
->vgl 81-7-1: relu, lernrate noch kleiner, noch mehr Daten, Modell tiefer, schmaller
->vgl 81-7: learn rate kleiner, mehr Daten, delta kleiner
-Verlängerung der Lerndauer
-Aktivierungsfunkt. LeakyReLU
-Mehr Daten
...
#-2---Settings------------------------------------------------------------------
path_training_data = "/content/82F_CTR_p-nr-lett-8-By_k-8-By_5000000_.csv"
path_test_data="/content/82F_CTR_p-nr-lett-8-By_k-8-By_1000_.csv"
...
#Speichert automatisch das beste Modell während des Trainings
...
'''
dict_keys(['k_out_auc_1', 'k_out_binary_accuracy', 'k_out_loss', 'k_out_precision_1', 'k_out_recall_1', 'loss', 'p_out_auc', 'p_out_binary_accuracy', 'p_out_loss', 'p_out_precision', 'p_out_recall', 'val_k_out_auc_1', 'val_k_out_binary_accuracy', 'val_k_out_loss', 'val_k_out_precision_1', 'val_k_out_recall_1', 'val_loss', 'val_p_out_auc', 'val_p_out_binary_accuracy', 'val_p_out_loss', 'val_p_out_precision', 'val_p_out_recall', 'learning_rate'])
'''
...
model.compile(
    ...
    metrics={ 'p_out': [BinaryAccuracy(), AUC(), Precision(), Recall()],
              'k_out': [BinaryAccuracy(), AUC(), Precision(), Recall()]}
...
#-7---Vorhersage----------------------------------------------------------------
#-Nur c-Features-Anzahl aus dem Val extrahieren
X_val_c = X_val[:, :X_c.shape[1]]


#-Eingabe für Vorhersage zusammenbauen------------------------------------------
...
#---Loss Verlauf---
loss_name=f"{prefix}-P, K, Gesamt- Loss Verlauf"
plt.figure(figsize=(10, 6))
...
results = model.evaluate(X_val, [y_p_val, y_k_val], verbose=0)
