...
Exemplarische Modelltraining (Basis Exp. 1-2, Exp. Script 81-2)
In einzelnen Experimente werden einzelne Parameter variiert.

Ablauf:
1. CSV Datei mit p,c,k-Werten einlesen
2. c-features extrahieren
3. Werte passend zusammenstellen
...
#-2---Settings------------------------------------------------------------------
path_training_data = "/content/82F_CTR_p-nr-lett-8-By_k-8-By_1000000_.csv"
...
#-Verizizieren-64 Bits-Hex-String = 64/4 = 16 Zeichen
...
print("Vorgersage auf Trainingsdatensatz abgeschlossen")
