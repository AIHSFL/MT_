...
'''
Script:81-8
Modeldimension entsprechend Eingangsparameter c=64 Bit angepasst
Daten: CTR-Mode
Model: Input[c] | Output[p,k]
...
#-Feature-Extraktion------------------------------------------------------------
X_c = np.vstack(df['c'].apply(hex_to_bin_vector).values)
...
X_test_c = np.vstack(test_df['c'].apply(hex_to_bin_vector).values)
